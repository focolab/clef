"""
Tests for clef ConfigManager and config validation.

All tests load the actual default YAML files from clef/core/config/
...
from core.config.IOConfig import IOConfig, InputDeviceConfig, OutputDeviceConfig
