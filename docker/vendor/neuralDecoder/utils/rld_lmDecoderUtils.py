"""
Drop-in replacement for lmDecoderUtils that doesn't require tensorflow at import time.
TF is only imported lazily inside build_gpt2 / the TF branch of rescore_with_gpt2.
"""
